...
/**
  Converts a range of IPs (both v4 and v6) from a CIDR-encoded string to two sockaddr datastructures representing the lower/upper bounds of the IP range.
  Returns PrefixParseError::ok only on successful conversion.
*/
extern PrefixParseError
